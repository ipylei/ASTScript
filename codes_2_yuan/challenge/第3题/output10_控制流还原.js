...
console.debug(window.W(1234567890123));
console.debug(window.W(1234567890123));
console.debug(window.W(1234567890123));
console.debug(window.W(Date["parse"](new Date())));
console.debug(window.W(Date["parse"](new Date())));
console.debug(window.W(Date["parse"](new Date())));
...
app.get('/api', (req, res) => {
  ...
  // console.log(typeof Date["parse"](new Date()));
  res.send({
    code: 200,
    // data: window.W(Date["parse"](new Date()))
    data: window.W(Number(req.query.data))
  })
})
