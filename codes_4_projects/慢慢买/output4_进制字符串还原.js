var customRequest = {
  ...
  'getTicket': function () {
    ...
    if (_0x3f166f["length"] > 4) {
      _0x3f166f = _0x3f166f["substr"](_0x3f166f["length"] - 4, 4) + _0x3f166f["substring"](0, _0x3f166f["length"] - 4);
    }
    return _0x3f166f;
  },
  ...
  'getQueryString': function (_0x27900f, _0x328ee5) {
    ...
    var _0x2f0f53 = '';
    if (_0x27900f["indexOf"]('?') > 0) {
      var _0x38c3a8 = _0x27900f["split"]('?');
      var _0x35fe6c = _0x38c3a8[1]['split']('&');
      for (var _0x1878c0 = 0; _0x1878c0 < _0x35fe6c["length"]; _0x1878c0++) {
        if ("WWI" !== "dBZ") {
          var _0x65c10d = _0x35fe6c[_0x1878c0]['split']('=');
          if (_0x65c10d[0] == _0x328ee5 && _0x65c10d[1] != '') {
            _0x2f0f53 = _0x65c10d[1];
            break;
          }
        } else {
  ...
  'formatDate': function (_0x5688c3) {
    ...
    while (!![]) {
      switch (_0xcee084[_0x280652++]) {
        case '0':
          var _0x59757c = _0x218ccb["getMonth"]() + 1;
          continue;
        case '1':
          if (_0x4da2b7 < 10) {
        ...
        case '6':
          if (_0x59757c < 10) {
            if ("ifo" !== "lcL") {
              ...
              var _0x17fb5c = Math["floor"](Math["random"]() * 16)["toString"](16);
              guid += _0x17fb5c;
            }
          }
          continue;
    ...
    while (!![]) {
      switch (_0xd33500[_0x2eacd7++]) {
        ...
        case '6':
          if (_0x39a7a5 < 10) {
            if ('IOp' !== "IOp") {
              ticket = ticket['substr'](ticket['length'] - 4, 4) + ticket["substring"](0, ticket["length"] - 4);
            } else {
        ...
        case '10':
          ...
          continue;
        case '11':
          var _0x39a7a5 = _0x3466bf["getMonth"]() + 1;
          continue;
        case '12':
  ...
  'SignGuid': function () {
    ...
    var _0x3f5930 = "tool-";
    for (var _0x257fca = 1; _0x257fca <= 16; _0x257fca++) {
      var _0x3ee1de = Math['floor'](Math["random"]() * 16)['toString'](16);
      _0x3f5930 += _0x3ee1de;
    }
    return _0x3f5930;
  },
  'hitDown': function (_0x496aab) {
    ...
    if (window["localStorage"]["getItem"]("hitdownname") == null) {
      if ("PPe" === "PPe") {
        ...
        if (_0x453269['length'] > 4) {
          _0x453269 = _0x453269['substr'](_0x453269["length"] - 4, 4) + _0x453269["substring"](0, _0x453269["length"] - 4);
        }
        return _0x453269;
      }
    } else {
